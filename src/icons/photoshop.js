...
class IconPhotoshop extends Component {
  constructor(props) {
    super(props);
  ...
  render() {
    return (
      <svg className="icon photoshop" style={ this.state.currentPosition } xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128">
